...
function App() {
  ...
  const portfolioItems = [
    {
      ...
      icon: Domain,
      description:
        "Web platform for viewing and annotating images and 3D models created using images from drones.",
    ...
    },
    {
      ...
      description: (
        <Text>
          A small tool/lib to read temperatures and original photos from FLIR®
          thermal camera images.
          <br />
          <Image
            style={{ marginTop: "10px" }}
            src="https://img.shields.io/pypi/dm/flirimageextractor?style=flat-square"
          />
        </Text>
      ),
    ...
    },
    {
      ...
      icon: Github,
      description:
        "An Augmented and Alternative Communication (AAC) web app to help a child who is not able to speak learn to communicate with those around them",
  ...
  return (
    <Grommet theme={theme[scheme]} full>
      <BrowserRouter>
        <Box align="center">
          <Box
            width="xlarge"
            alignSelf="center"
            style={{ paddingBottom: "20x" }}
          >
